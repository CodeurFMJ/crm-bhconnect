-- Import basique pour Supabase - CRM BhConnect
-- Données simples sans caractères spéciaux
...
(2, 'User', 'user@example.com', '2025-01-01 00:00:00', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'user', 'token456', '2025-01-01 00:00:00', '2025-01-01 00:00:00');
...
(1, 'Tache Test 1', 'Description de la tache test 1', 'pending', 'high', '2025-01-10 00:00:00', 1, 1, '2025-01-01 00:00:00', '2025-01-01 00:00:00'),
(2, 'Tache Test 2', 'Description de la tache test 2', 'in_progress', 'medium', '2025-01-15 00:00:00', 2, 1, '2025-01-01 00:00:00', '2025-01-01 00:00:00');
